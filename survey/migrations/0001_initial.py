    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer_type', models.CharField(choices=[('check_box', 'Check Box'), ('date', 'Date'), ('description', 'Description'), ('image', 'Image'), ('location', 'Location'), ('number', 'Number'), ('single_option', 'Single Option'), ('multiple_option', 'Multiple Option')], max_length=15)),
